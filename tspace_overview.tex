...
\begin{tikzpicture}[
  ...
  \draw (av.317) edge [arrows={-Stealth[harpoon]},"raw"'] (cl.133)
        (cl.137) edge [arrows={-Stealth[harpoon]},"level"] (av.313);
  \draw (kv.272) edge [arrows={-Stealth[harpoon]},"raw"] (v.88)
        (v.92) edge [arrows={-Stealth[harpoon]},"level"] (kv.268);
  \draw (v.47) edge [arrows={-Stealth[harpoon]},"raw"] (cl.223)
        (cl.227) edge [arrows={-Stealth[harpoon]},"level"'] (v.43);
\end{tikzpicture}
\end{document}
