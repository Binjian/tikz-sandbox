...
\begin{tikzpicture}[
  ...
  \draw (av.2) edge [->,dotted,"Config.\&Sched."] (cr.178)
        (cr.2) edge [arrows={-Stealth[harpoon]},"raw data"'] (ag.178);
  \draw (ag.182) edge [arrows={-Stealth[harpoon]},"raw"] (cr.358);
  \draw (kv.47) edge [arrows={-Stealth[harpoon]},"Pipeline\texttt{\string[CAN/Dataframe\string]}"] (cr.223)
        (cr.227) edge [arrows={-Stealth[harpoon]},"Pipeline\texttt{\string[Dataframe/CAN\string]}"'] (kv.43);
  \draw (cl.227) edge [arrows={-Stealth[harpoon]},"Pipeline\texttt{\string[CAN/Dataframe\string]}"] (cr.133)
        (cr.137) edge [arrows={-Stealth[harpoon]},"Pipeline\texttt{\string[Dataframe/CAN\string]}"'] (cl.223);
